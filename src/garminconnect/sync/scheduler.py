...
class GarminScheduler:
    ...
    def run_once(self) -> None:
        ...
        self.pipeline.sync_race_predictions()
        self.pipeline.sync_workouts()
        self.pipeline.sync_personal_records()
        self.pipeline.sync_badges()
        self.pipeline.sync_lactate_threshold()
        self.pipeline.sync_cycling_ftp()
        self.pipeline.sync_gear()
        self.pipeline.sync_hydration(yesterday)
        self.pipeline.sync_hydration(today)
